...
MATH_CONFIG = Path("configs/math.toml")
COM_CONFIG = Path("configs/com.toml")

def user_determines():
    dataType = input("Enter Subject Math('mat'), Portuguese('por'), or Portuguese + Math('com') : ")

    if dataType == "com":
        print("student-mat.csv + student-por.csv will be used.")
        return COM_CONFIG
    elif dataType == "mat":
        print("student-mat.csv will be used.")
        return MATH_CONFIG
    else:
        print("student-por.csv will be used.")
