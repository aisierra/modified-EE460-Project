...
3. **Configure API Key**: The intervention planner uses an LLM prompt chain powered by Google's Gemini. You must export your API key before running simulations.
   ```bash
